 ...
 */
require_once(Yii::getPathOfAlias('webroot').'/protected/vendors/fpdf17/fpdf.php');
...
{
    // Logo
    $this->Image(Yii::getPathOfAlias('webroot').'/images/logoalcaldia.jpg',20,13,40);
	//$this->Image('C:\AppServ\www\implementacionCentroForjar\imagenes\SDIS.png',41,15,20);
    ...
    $this->Cell(40);
    // Título
    $this->Cell(135,-5,'CENTRO FORJAR',0,0,'C');
	$this->Ln(0);
	$this->SetFont('Arial','',10);
    $this->Cell(40);
	$this->MultiCell(135,5,utf8_decode('Servicio de Atención Integral Especializada para Adolescentes vinculados al Sistema de Responsabilidad Penal Adolescente - SRPA'),0,'C',false);
$this->defaultFontFamily = 'Arial';
$this->defaultFontStyle  = '';
$this->defaultFontSize   = 9;


//$this->htmltable($tableCaezote);
