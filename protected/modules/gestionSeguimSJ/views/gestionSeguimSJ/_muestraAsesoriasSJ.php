...
$this->widget('application.extensions.jqAjaxSearch.AjaxSearch', 
    array('action'=>Yii::app()->createUrl('modIdenReg/identificacionRegistro/buscaAdolGen'), 
		...
		'url'=>Yii::app()->createUrl('gestionSeguimSJ/gestionSeguimSJ/muestraAsesoriasSJ'),
		'datosAdol'=>$datosAdol,
		'edad'=>$edad,
...
<?php if(!empty($numDocAdol)): ?>
    ...
    foreach($consultaGestionesAdol as $pk=>$gestionAdolSJ):?>    
		...
		?>
        <tr class="odd gradeX">
            <td><?php echo $gestionAdolSJ["nombres"]." ".$gestionAdolSJ["apellido_1"]." ".$gestionAdolSJ["apellido_2"];?></td>
            <td><?php echo $gestionAdolSJ["num_doc"];?></td>
            ...
            <td>
				<?php 
					...
					echo CHtml::link('Realizar seguimiento','Realizar seguimiento',array('submit'=>array('gestionSeguimSJ/muestraFormSegGSJ'),'params'=>array('id_gestionsj'=>$gestionAdolSJ["id_gestionsj"],'numDocAdol'=>$gestionAdolSJ["num_doc"]))); 
				?>					        
            </td>
         </tr>
    <?php
