<div class="panel-heading color-sdis">Modificar contratos</div> 
...
<?php echo $formularioContratoFunc->labelEx($modeloDatosContrato,'fecha_contrato',array('class'=>'col-md-4 control-label','for'=>'searchinput'));?>
	...
	<?php //
		$this->widget('zii.widgets.jui.CJuiDatePicker',
			...
			'name'=>'fecha_contrato',
			'id'=>'DatosContrato_fecha_contrato',
...
<div class="form-group">
    ...
    <div class="col-md-8">
       <?php $boton=CHtml::ajaxSubmitButton (
            'Modificar Contrato',   
            array('modificarContratoFuncionario'),
            array(				
                'dataType'=>'json',
                'type' => 'post',
                'beforeSend'=>'function (){
