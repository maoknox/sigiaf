...
class LocalizacionViv extends CActiveRecord
{
	...
	public function registraLocAdol(){
		...
		try{
			...
			$creaLocAdol->bindParam(':idEstrato',$this->id_estrato,PDO::PARAM_NULL);
			$creaLocAdol->bindParam(':idMunicipio',$municipio,PDO::PARAM_STR);
			$creaLocAdol->bindParam(':idLocalidad',$this->id_localidad,PDO::PARAM_NULL);
			$creaLocAdol->bindParam(':Barrio',$this->barrio,PDO::PARAM_STR);
			$creaLocAdol->bindParam(':Direccion',$this->direccion,PDO::PARAM_NULL);
			$creaLocAdol->execute();
			$transaction->commit();
