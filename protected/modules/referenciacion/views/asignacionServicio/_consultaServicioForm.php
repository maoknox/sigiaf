...
<?php echo CHtml::link('Siguiente','Siguiente',array('submit'=>array('asignacionServicio/consultaServicioForm'),'params'=>array('offset'=>$superior))); ?>
<?php else: $superior=$offset+5; $inferior=$offset-5?>
<?php echo CHtml::link('Anterior','Siguiente',array('submit'=>array('asignacionServicio/consultaServicioForm'),'params'=>array('offset'=>$inferior))); ?>
