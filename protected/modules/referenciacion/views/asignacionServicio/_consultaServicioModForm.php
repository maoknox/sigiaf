...
<?php if(!empty($numDocAdol)):?>
	<?php if(empty($datosRef) && $offset==0):?>
         <hr />
	...
	<?php else:?>
      <strong>Listado de referenciaciones</strong>
        ...
        <tr>
            ...
            <td style="border:1px solid #000">
                ...
                <?php 
                    ...
                    echo CHtml::button(
                    'Ver referenciación',
                    array('onclick'=>'js:servicioModForm("'.$pk.'")')
        ...
        <?php echo CHtml::link('Siguiente','Siguiente',array('submit'=>array('asignacionServicio/consultaServicioModForm'),'params'=>array('offset'=>$superior))); ?>
        <?php else: $superior=$offset+5; $inferior=$offset-5?>
        <?php echo CHtml::link('Anterior','Siguiente',array('submit'=>array('asignacionServicio/consultaServicioModForm'),'params'=>array('offset'=>$inferior))); ?>
        ...
        <?php Yii::app()->getClientScript()->registerScript('script_modifestado','
            function servicioModForm(idForm){
