...
class ReferenciacionAdol extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('num_doc,id_tipo_referenciacion, id_estadoref, fecha_referenciacion,id_esp_sol,id_beneficiario', 'required'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'id_esp_soliii' => 'Id Esp Soliii',
			'id_esp_solii' => 'Id Esp Solii',
			'id_estadoref' => 'Id Estadoref',
			'fecha_referenciacion' => 'Fecha Referenciacion',
			'fecha_gestion' => 'Fecha Gestion',
			'institucion_ref' => 'Institucion Ref',
			'resultado_gestion' => 'Resultado Gestion',
			'observaciones_refer' => 'Observaciones Refer',
			'satisfactoriedad_gestion' => 'Satisfactoriedad Gestion',
			'satisfactoriedad_vinculacion' => 'Satisfactoriedad Vinculacion',
			'culminacion_refer' => 'Culminacion Refer',
			'estado_sol_refer' => 'Estado Sol Refer',
		);
	}
