...
<!-- Form Name -->
<div class="panel-heading color-sdis">Habilitar área de interés</div><br />
							...
							'success' => 'function(datos) {	
								...
								if(datos.estadoComu=="exito"){
									if(datos.resultado=="exito"){
										jAlert("Área de interés habilitada","Mensaje");
...
<!-- Form Name -->
<div class="panel-heading color-sdis">Habilitar deportes</div><br />
	<?php echo  $formularioCreaAreaInt->errorSummary($modeloAreainscrCforjar,'','',array('style' => 'font-size:14px;color:#F00')); ?>
		...
		$boton=CHtml::ajaxSubmitButton (
						...
						array(				
							...
							'success' => 'function(datos) {	
								...
								if(datos.estadoComu=="exito"){
									if(datos.resultado=="exito"){
										jAlert("Deporte habilitado","Mensaje");
