...
<br />
		...
		<?php $formularioLabClinicosExtra=$this->beginWidget('CActiveForm', array(
           ...
           <div class="form-group"> 
                ...
                <div class="col-sm-2">
                    <?php echo $formularioLabClinicosExtra->textField($modeloLabclinValnutr,'resultado_labclin',array('class'=>'form-control input-md','onkeyup'=>'js:$("#fieldDatosNacim").addClass("has-warning");'));?>
