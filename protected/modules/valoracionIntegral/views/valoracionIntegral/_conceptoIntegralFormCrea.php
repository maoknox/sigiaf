...
<?php if($consEstPsicol["id_estado_val"]==1 && $consEstTrSocial["id_estado_val"]==1):?>
	...
	<div class="form-group">
        <div class="col-md-4">
			<?php $boton=CHtml::ajaxSubmitButton (
				'Registrar Concepto',   
				array('valoracionIntegral/registraConcInt'),
				array(				
					'dataType'=>'json',
					'type' => 'post',
...
?>
<?php else:?>
	<?php if($consEstPsicol["id_estado_val"]!=1):?>
    	<?php $mensaje="El adolescente no tiene completa la valoración en Psicología";?>
	<?php endif;?>
    <?php if($consEstTrSocial["id_estado_val"]!=1):?>
    	<?php $mensaje="El adolescente no tiene completa la valoración en Trabajo Social";?>
	<?php endif;?>
    <hr />
