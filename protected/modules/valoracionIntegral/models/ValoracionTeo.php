 ...
 * @property integer $id_tipo_trab
 * @property integer $id_sector_lab
 ...
 * @property SectorLaboral $idSectorLab
 * @property TipoTrabajador $idTipoTrab
 */
class ValoracionTeo extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('id_estado_val, id_tipo_trab, id_sector_lab', 'numerical', 'integerOnly'=>true),
	...
	public function relations()
	{
		...
		return array(
			...
			'profesionalTos' => array(self::HAS_MANY, 'ProfesionalTo', 'id_valor_teo'),
			'idEstadoVal' => array(self::BELONGS_TO, 'EstadoValoracion', 'id_estado_val'),
			'idSectorLab' => array(self::BELONGS_TO, 'SectorLaboral', 'id_sector_lab'),
			'idTipoTrab' => array(self::BELONGS_TO, 'TipoTrabajador', 'id_tipo_trab'),
	...
	public function search()
	{
		...
		$criteria->compare('id_tipo_trab',$this->id_tipo_trab);
		$criteria->compare('id_sector_lab',$this->id_sector_lab);
