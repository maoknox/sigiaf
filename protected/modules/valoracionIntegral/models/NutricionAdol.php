...
class NutricionAdol extends CActiveRecord
{
	...
	public function creaRegNutricionSeguimiento(){
		...
		try{
			...
			$regNutrAdol->bindParam(":id_val_nutricion",$this->id_val_nutricion,PDO::PARAM_INT);
			$regNutrAdol->bindParam(":id_tipoact_pld",$this->id_tipoact_pld,PDO::PARAM_INT);
			$regNutrAdol->bindParam(":diagnostico_clasif_nutr_na",$this->diagnostico_clasif_nutr_na);
			$regNutrAdol->bindParam(":eval_cumpl_obj_alim",$this->eval_cumpl_obj_alim);
			$regNutrAdol->bindParam(":plan_nutr",$this->plan_nutr);
			$regNutrAdol->bindParam(":ant_salud_al_cl",$this->ant_salud_al_cl);
			$regNutrAdol->bindParam(":fecha_segnutr",$fechaSeg,PDO::PARAM_STR);
			$regNutrAdol->execute();
			$transaction->commit();
			return "exito";
