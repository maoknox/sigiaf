...
$this->widget('application.extensions.jqAjaxSearch.AjaxSearch', 
    array('action'=>Yii::app()->createUrl('valoracionIntegral/valoracionIntegral/buscaAdolGen'), 
		...
		'url'=>Yii::app()->createUrl('seguimientoAdol/seguimientoAdol/consSegAdol'),
		'datosAdol'=>$datosAdol,
		'edad'=>$edad,
...
<?php if(!empty($numDocAdol)):?>
	...
	<?php
        if(empty($paiAdol)){
            $seguimiento=array("Seguimiento del Adolescente"=>$this->renderPartial("_consSegTab", 
            array(
                'numDocAdol'=>$numDocAdol,	
                'datosAdol'=>$datosAdol,
                'edad'=>$edad,
            ...
            if($paiAdol["culminacion_pai"]==1){
                $seguimiento=array("Seguimiento Pos Egreso"=>$this->renderPartial("_consSegPosEgr", 
                array(
                    'numDocAdol'=>$numDocAdol,	
                    'modeloInfJud'=>$modeloInfJud,
                    'infJudicial'=>$infJudicial,
