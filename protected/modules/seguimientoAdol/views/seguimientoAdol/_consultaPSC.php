...
<?php if(!empty($numDocAdol)):
	...
	if(!empty($infJudicial)):
		...
		<?php else:?>
			<div>El adolescente no tiene una sanción de PSC (Prestación de servicios a la comunidad)</div>
		<?php endif;?>
    <?php else:?>
			<div>No se ha creado el registro de Información Judicial Administrativa del adolescente o el adolescente no tiene una sanción de PSC (Prestación de servicios a la comunidad)</div>
    <?php endif;?>  
<?php endif;?>
