...
<?php if(!empty($pscSinCulm)):?>
        ...
        <div id="divFechas">
			...
			$selectHoras=array();
			$selectMinutos=array();;
			foreach($consultaAsistencia as $pk=>$asistenciaPsc):$numFechas++;?>
            	
				<?php
					$selectHoras[$asistenciaPsc["num_hora"]]="selected='selected'";
					$selectMinutos[$asistenciaPsc["num_minutos"]]="selected='selected'";
					$horas="<option value='1' ".$selectHoras[1].">1</option>";
					$horas.="<option value='2' ".$selectHoras[2].">2</option>";
					$horas.="<option value='3' ".$selectHoras[3].">3</option>";
					$horas.="<option value='4' ".$selectHoras[4].">4</option>";
					$horas.="<option value='5' ".$selectHoras[5].">5</option>";
		
					$minutos="<option value='0' ".$selectMinutos[0].">0</option>";
					$minutos.="<option value='10' ".$selectMinutos[10].">10</option>";
					$minutos.="<option value='15' ".$selectMinutos[15].">15</option>";
					$minutos.="<option value='20' ".$selectMinutos[20].">20</option>";
					$minutos.="<option value='25' ".$selectMinutos[25].">25</option>";
					$minutos.="<option value='30' ".$selectMinutos[30].">30</option>";
					$minutos.="<option value='35' ".$selectMinutos[35].">35</option>";
					$minutos.="<option value='40' ".$selectMinutos[40].">40</option>";
					$minutos.="<option value='45' ".$selectMinutos[45].">45</option>";
					$selectHoras=array();
					$selectMinutos=array();;
				?>
     			<div class="form-group" id="horaFecha_<?=$numFechas?>">
                	<label class="col-md-4 control-label"></label>
                    <div class="col-sm-1">
						<?=$asistenciaPsc["fecha_asist_psc"]?>
                        <input type="hidden" id="inpFecha_<?=$numFechas?>" class="<?=$asistenciaPsc["fecha_asist_psc"]?>" value="<?=$asistenciaPsc["fecha_asist_psc"]?>" name="AsistenciaPsc[inpFecha_<?=$numFechas?>]"/>
                    </div>
                    <div class="col-sm-1">
                    	<select id="num_horas_<?=$numFechas?>" name="AsistenciaPsc[num_horas_<?=$numFechas?>]" >
							<?=$horas?>
                        </select>
                    </div>
                    <div class="col-sm-1">
                    	<select id="num_minutos_<?=$numFechas?>" name="AsistenciaPsc[num_minutos_<?=$numFechas?>]"><?=$minutos?></select>
                   	</div>
                </div>  
       		<?php endforeach;?>
        </div>  
        <?php echo CHtml::hiddenField('numFechas',count($consultaAsistencia));?>
        ...
        <div class="form-group">
            <div class="col-md-4">
                <?php echo $formSegPsc->hiddenField($modeloSeguimientoPsc,'id_seguimiento_ind');?>
