	...
	function enviaFormPlanDietario(nombreForm,idComida){
		//jAlert($("#formularioPorcionesComida"+idComida).serialize());
			$.ajax({
				...
				data:$("#formularioPorcionesComida"+idComida).serialize(),
				dataType:"json",
				type: "post",
				beforeSend:function (){Loading.show();},
				success: function(datos){
					...
					if(datos.estadoComu=="exito"){
						...
						if(datos.resultado=="exito"){
							...
							$("#formularioPorcionesComida"+idComida+" #PorcionesComida_num_porc_recomendadas_em_").text("");
							$("#formularioPorcionesComida"+idComida+" #PorcionesComida_num_porc_recomendadas_em_").hide(""); 			
