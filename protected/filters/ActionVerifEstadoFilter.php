...
class ActionVerifEstadoFilter extends CFilter{
	public $num_doc;
    protected function preFilter($filterChain){
		...
		$estadoAdol=$modeloForjarAdol->consultaDatosForjarAdol();		
			...
			elseif(empty($estadoAdol)){
				Yii::app()->user->setFlash('verifEstadoAdolForjar', "El adolescente no se encuentra activo en el servicio, debe cambiar el estado a activo.");									
			}
		$filterChain->run();
